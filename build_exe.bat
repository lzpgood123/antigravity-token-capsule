...
powershell -Command "Compress-Archive -Path 'dist\onedir\token-capsule\*' -DestinationPath 'dist\zip\token-capsule-v1.2.1-windows-x64.zip' -Force"
...
echo   1. Windows Installer: dist\installer\token-capsule-Setup-v1.2.1.exe
echo   2. Portable ZIP:      dist\zip\token-capsule-v1.2.1-windows-x64.zip
